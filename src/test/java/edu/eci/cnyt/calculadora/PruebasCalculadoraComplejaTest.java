...
public class PruebasCalculadoraComplejaTest {
	...
	private Matriz hermitian = new Matriz(
			new Complejo[][] { { new Complejo(5, 0), new Complejo(4, 5), new Complejo(6, -16) },
	...
	private Matriz matrizTensor = new Matriz(new Complejo[][] {
			{ new Complejo(-3, 1), new Complejo(0, -4), new Complejo(-2, 2), new Complejo(0, 0), new Complejo(0, 0),
					new Complejo(0, 0) },
			{ new Complejo(-1, 5), new Complejo(2, 4), new Complejo(0, 4), new Complejo(0, 0), new Complejo(0, 0),
					new Complejo(0, 0) },
			{ new Complejo(-3, -1), new Complejo(2, 0), new Complejo(1, 3), new Complejo(0, 0), new Complejo(0, 0),
					new Complejo(0, 0) },

			{ new Complejo(-1, 2), new Complejo(-2, -2), new Complejo(0, 2), new Complejo(-2, -1), new Complejo(2, -2),
					new Complejo(-2, 0) },
			{ new Complejo(2, 3), new Complejo(3, 1), new Complejo(2, 2), new Complejo(-3, 2), new Complejo(-1, 3),
					new Complejo(-2, 2) },
			{ new Complejo(-2, 1), new Complejo(1, -1), new Complejo(2, 1), new Complejo(-1, -2), new Complejo(1, 1),
					new Complejo(-1, 2) } });
	private DobleRendijaClasica rendijaClasica;
	private DobleRendijaCuantica rendijaCuantica;
	...
	@Test
	public void canicasCuantico() {
		Complejo[][] matrizCompleja = new Complejo[][] {
				{ new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(1, 0) },
				{ new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(1, 0), new Complejo(0, 0), new Complejo(0, 0) },
				{ new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(1, 0), new Complejo(0, 0) },
				{ new Complejo(0, 0), new Complejo(0, 0), new Complejo(1, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0) },
				{ new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(1, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0) },
				{ new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(1, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0) },
				{ new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(1, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(1, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0) },
				{ new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(1, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0) },
				{ new Complejo(0, 0), new Complejo(1, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0) },
				{ new Complejo(1, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0) },
				{ new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0),
						new Complejo(0, 0), new Complejo(0, 0), new Complejo(0, 0), new Complejo(1, 0),
	...
	public void noDeberiaHacerCanicas() {
		assertTrue(!m1.experimentoCanicas(25, m1, v1).equals(v3));
	}

	@Test
	public void noDeberiaHacerDobleRendija() {
		try {
			rendijaClasica = new DobleRendijaClasica(0, 5,
					new int[][] { { 2, 3 }, { 4, 5, 6 }, { 6, 7, 8 }, { 4 }, { 5 }, { 6 }, { 7 }, { 8 } });
			double[] click = rendijaClasica.click(4);
		} catch (Exception ex) {
			assertTrue(true);
		}
	}
	...
	public void deberiaHacerDobleRendija() {
		try {
			rendijaClasica = new DobleRendijaClasica(2, 5,
					new int[][] { { 2, 3 }, { 4, 5, 6 }, { 6, 7, 8 }, { 4 }, { 5 }, { 6 }, { 7 }, { 8 } });
			double[] click = rendijaClasica.click(4);
		} catch (Exception ex) {
			assertTrue(false);
	...
	@Test
	public void deberiaHacerDobleRendijaCaso2() {
		try {
			rendijaClasica = new DobleRendijaClasica(2, 5,
					new int[][] { { 2, 3 }, { 7, 8, 5, 6 }, { 6, 7, 8 }, { 4 }, { 5 }, { 6 }, { 7 }, { 8 } });
			double[] click = rendijaClasica.click(4);
		} catch (Exception ex) {
			assertTrue(false);
		}
	...
	@Test
	public void deberiaHacerDobleRendijaUltimoCaso() {
		try {
			rendijaClasica = new DobleRendijaClasica(2, 5,
					new int[][] { { 2, 3 }, { 7, 8, 5, 6 }, { 6, 7, 8 }, { 4 }, { 5 }, { 6 }, { 7 }, { 8 } });
			double[] click = rendijaClasica.click(1);
			//rendijaClasica.imprimirEstado(click);
	...
	@Test
	public void deberiaDobleRendijaCuanticaHcaer() {
		Lista[][] l = new Lista[][] {{new Lista(5, c2), new Lista(5, c3)}, {new Lista(1, c1), new Lista(5, c3)}};
	
		try {
			rendijaCuantica = new DobleRendijaCuantica(6, 5, l);
			Complejo[] click = rendijaCuantica.click(4);
		} catch (Exception ex) {
			assertTrue(false);
		}
	}
	...
	@Test
	public void noDeberiaHacerDobleRendijaCuantica() {
		Lista[][] l = new Lista[][] {{new Lista(2, c2), new Lista(3, c3)}, 
									{new Lista(4, c2), new Lista(5, c3), new Lista(6, c3)},
									{new Lista(6, c2), new Lista(7, c3), new Lista(8, c3)},
									{new Lista(4, c2)},
									{new Lista(5, c2)},
									{new Lista(6, c2)},
									{new Lista(7, c2)},
		...
		try {
			rendijaCuantica = new DobleRendijaCuantica(0, 5, l);
			Complejo[] click = rendijaCuantica.click(4);
			new Vector(click).imprimir();
		} catch (Exception ex) {
			assertTrue(true);
		}
	}
